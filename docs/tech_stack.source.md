...
*   **Штучний інтелект та математика:**
    ...
    *   **Алгоритм адаптивного вибору контенту (Task Sequencing / Learning Path Recommendation):** Механізм динамічного планування індивідуальної навчальної траєкторії студента на основі поточного стану графа знань та обчислених ймовірностей $P(L_t)$. Включає логіку автоматичного підбору завдань відповідного рівня складності (наприклад, при досягненні порогу опанування навички $P(L_t) \ge 0.95$ система відкриває наступні залежні вузли графа, а у випадку прогалин чи аномальних пауз пропонує простіші або адаптовані практичні вправи).
