...
- **Адаптивне планування траєкторій (Task Sequencing / Recommendation):** Динамічне коригування навчального треку студента на основі поточної ймовірності засвоєння матеріалу $P(L_t)$. Система автоматично пропонує завдання оптимальної складності: відкриває наступні залежні вузли графа знань при успішному опануванні ($P(L_t) \ge 0.95$) або надає коригувальні вправи при виявленні прогалин.
