...
import DocsShell, { getSlug, formatMarkdown, renderParagraphs } from '../../components/DocsShell';

export default function RoadmapPage() {
  return (
    <DocsShell>
      {({ isDarkMode, filteredDoc, activeSection, scrollTo }) => <RoadmapContent isDarkMode={isDarkMode} filteredDoc={filteredDoc} activeSection={activeSection} scrollTo={scrollTo} />}
    </DocsShell>
  );
}
